...
# ============================================================
root = tk.Tk()
root.title("GMR UIN R1B - MQTT Subscriber")
...
tk.Label(
    frm_hdr_title,
    text="(MQTT Subscriber — GMR UIN R1B)",
...
# signed by: Gilang Pratama Putra Siswanto && Rakha Fadzilah Fathah(2026-05-16)